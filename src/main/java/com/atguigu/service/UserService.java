...
public class UserService implements UserDetailsService {
    ...
    static {
        ...
        user1.setPassword("$2a$10$lHpD8hCVpG98k3etr4viPubgjfTVzXIkvd8.o6dfb2mBJAX.Jw8xG");
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //参数三：存放当前用户具有的权限集合
        return new org.springframework.security.core.userdetails.User(username,passwordInDb,lists);//注意：框架提供的User类：org.springframework.security.core.userdetails.User
    }
